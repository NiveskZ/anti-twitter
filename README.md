...
Sem instalação adicional além da extensão. Livros armazenados no próprio browser via IndexedDB. Leitor de epub e PDF embutido.
...
- Livros (modo JS) são armazenados no IndexedDB do perfil do Firefox
